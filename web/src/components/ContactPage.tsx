...
export const ContactPage: React.FC = () => {
  ...
  const t = {
    id: {
      ...
      subtitle: 'Pintu kami selalu terbuka lebar. Apakah Anda ingin mengembangkan website premium, menerbitkan siaran pers bisnis, menyelenggarakan pelatihan SDM, atau sekadar berdiskusi santai di Malang Creative Center.',
      repTitle: 'Saluran Komunikasi Resmi',
      repSubtitle: 'Pilih metode komunikasi yang paling nyaman bagi Anda. Tim kami siap memberikan pelayanan terbaik.',
      office: 'KANTOR PUSAT',
      ...
      formSub: 'Isi brief singkat di bawah ini, dan koordinator dari pilar layanan terkait akan merespons dalam kurang dari 4 jam kerja.',
    ...
    en: {
      ...
      repSubtitle: 'Choose the communication method most comfortable for you. Our team is ready to provide excellent service.',
      office: 'HEADQUARTERS',
      officeName: 'Telkom AI Center Malang',
      officeAddr: 'Jl. Jenderal Basuki Rahmat No.7-9, Kauman, Kec. Klojen, Kota Malang, Jawa Timur 65119',
      ...
      hoursValue: 'Monday – Friday, 08:30–17:00 WIB (Western Indonesia Time)',
