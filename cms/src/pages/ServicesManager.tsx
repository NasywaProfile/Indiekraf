        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl my-8">
            ...
            <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Caption Overlay Gambar (Bahasa Indonesia)</label>
                  <textarea
                    rows={2}
                    value={formPillar.img_desc_id || ''}
                    onChange={e => updatePillarField('img_desc_id', e.target.value)}
                    className="w-full px-3 py-2 border rounded-xl text-sm focus:ring-2 focus:ring-blue-100"
                    placeholder="Keterangan singkat yang muncul di bawah gambar"
                  />
                </div>
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Caption Overlay Gambar (English)</label>
                  <textarea
                    rows={2}
                    value={formPillar.img_desc_en || ''}
                    onChange={e => updatePillarField('img_desc_en', e.target.value)}
                    className="w-full px-3 py-2 border rounded-xl text-sm focus:ring-2 focus:ring-blue-100"
                    placeholder="Short description overlay on the bottom of the image"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Ikon</label>
                  <select value={formPillar.icon || 'Layers'} onChange={e => updatePillarField('icon', e.target.value)} className="w-full px-3 py-2 border rounded-xl text-sm">
                ...
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Link Default (misal: www.indiekraf.com)</label>
                  <input value={formPillar.link || ''} onChange={e => updatePillarField('link', e.target.value)} className="w-full px-3 py-2 border rounded-xl text-sm" placeholder="e.g. www.indiekraf.com" />
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Tagline (ID)</label>
                  <input value={formPillar.tagline_id || ''} onChange={e => updatePillarField('tagline_id', e.target.value)} className="w-full px-3 py-2 border rounded-xl text-sm" />
                </div>
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Tagline (EN)</label>
                  <input value={formPillar.tagline_en || ''} onChange={e => updatePillarField('tagline_en', e.target.value)} className="w-full px-3 py-2 border rounded-xl text-sm" />
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Subtitle / Label (ID)</label>
                  <input value={formPillar.subtitle_id || 'LAYANAN INDIEKRAF'} onChange={e => updatePillarField('subtitle_id', e.target.value)} className="w-full px-3 py-2 border rounded-xl text-sm" placeholder="LAYANAN INDIEKRAF" />
                </div>
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Subtitle / Label (EN)</label>
                  <input value={formPillar.subtitle_en || 'INDIEKRAF SERVICES'} onChange={e => updatePillarField('subtitle_en', e.target.value)} className="w-full px-3 py-2 border rounded-xl text-sm" placeholder="INDIEKRAF SERVICES" />
                </div>
              </div>
